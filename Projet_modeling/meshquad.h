...
public:
    ...
    /**
     * @brief trouve distance entre deux points
     * @param premier point [in]
     * @param deuxieme point [in]
     * @param distance entre eux [out]
     */
    ...
    /**
     * @brief calcul d'aire de triangle ABC
     * @param A
     * @param B
     * @param C
     * @return Aire de triangle ABC
     */
    float aire_tris( const Vec3& A, const Vec3& B, const Vec3& C  );

    /**
     * @brief calcul d'aire de quad ABCD
     * @param A
     * @param B
     * @param C
     * @param D
     * @return Aire de quad ABCD
     */
    float aire_quad( const Vec3& A, const Vec3& B, const Vec3& C, const Vec3& D );

    /**
     * @brief calcul de degrée d'angle ABC
     * @param A
     * @param B
     * @param C
     * @return degrée d'angle ABC
     */
    float angle( const Vec3& A, const Vec3& B, const Vec3& C );
